...
<div class="container mt-3 mt-md-5 mb-7">
        ...
        <table class="table rbt-table-responsive rbt-table-actions">
            ...
            <tbody>
                <tr class="demojs-active">
                    ...
                    <td><b class="rbt-table-responsive-cell-label">Status</b> <span class="rbt-table-responsive-cell-content">Live <button class="btn btn-sm btn-link text-decoration-none p-1 ml-2" role="button" data-toggle="popover"  data-trigger="focus" data-placement="bottom" data-content=" <ul class='mb-3 list-unstyled'>
    ...
    <li>The end date (4/21/2024) has not yet transpired.</li>
...
</ul>"><i class="rbt-icon-info-circle"><span class="sr-only">Info</span></i></button> </span></td>
                ...
                <tr class="demojs-active">
                    ...
                    <td><b class="rbt-table-responsive-cell-label">Status</b> <span class="rbt-table-responsive-cell-content">Live (recurring) <button class="btn btn-sm btn-link text-decoration-none p-1 ml-2" role="button" data-toggle="popover"  data-trigger="focus" data-placement="bottom" data-content=" <ul class='mb-3 list-unstyled'>
    <li>The verification is set to 'active'.</li>
    ...
    <li>There is no specified end date.</li>
                ...
                <tr class="demojs-inactive" style="display: none">
                    ...
                    <td class="demojs-active"><b class="rbt-table-responsive-cell-label">Status</b> <span class="rbt-table-responsive-cell-content">Inactive <button class="btn btn-sm btn-link text-decoration-none p-1 ml-2" role="button" data-toggle="popover"  data-trigger="focus" data-placement="bottom" data-content=" <ul class='mb-3 list-unstyled'>
    ...
    <li>The end date (4/21/2024) has not yet transpired.</li>
               ...
               <tr class="demojs-inactive" style="display: none">
                    ...
                    <td><b class="rbt-table-responsive-cell-label">Status</b> <span class="rbt-table-responsive-cell-content">Pending <button class="btn btn-sm btn-link text-decoration-none p-1 ml-2" role="button" data-toggle="popover"  data-trigger="focus" data-placement="bottom" data-content=" <ul class='mb-3 list-unstyled'>
    <li>The verification is set to 'active'.</li>
