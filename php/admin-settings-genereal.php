            ...
            <tbody>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_appname">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_defaultdefferbtntext">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_defaultdeffermessage">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_defaulttargeturl">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_defaultvfybtntext">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_defaultvfymessage">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_enableemail">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_errormessage">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_googleanaid">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_maintenanceresource">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_systememail">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_timezone">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_verificationintro">Edit</button>
                        </span></td>
                </tr>
                <tr>
                    ...
                    <td><b class="rbt-table-responsive-cell-label"> <span class="visible-xs"> Actions </span> </b> <span class="rbt-table-responsive-cell-content">
                        <button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#modal_gensettings_welcomemessage">Edit</button>
                        </span></td>
                </tr>
            </tbody>
        </table>
