...
<div class="container mt-3 mt-md-5 mb-5">
    <main class="main-content" id="main-content">
        ...
        <div class="row">
            <div class="col-12 col-lg-8" style="display: block" id="viewmode">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input value="ldap://ads.mydomain.edu" aria-labelledby="" class="form-control" id="ldap_url" type="text" disabled>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input value="ou=myOu,dc=ads,dc=myDomain,dc=edu" aria-labelledby="" class="form-control" id="ldap_base" type="text" disabled>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input value="cn=myUser,ou=myOu,dc=ads,dc=myDomain,dc=edu" aria-labelledby="" class="form-control" id="ldap_username" type="text" disabled>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <input value="xxxxxxxxx" aria-labelledby="" class="form-control" id="ldap_password" type="password" disabled>
                        </div>
                    </div>
                </div>
                <hr>
                <div class="rbt-button-group mt-3 mb-5" id="">
                    <button class="btn btn-primary" id="button_editmode"> <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true"></span> <span class="visible">Edit</span> </button>
                    <growls style=" display: none; position: absolute; left:160px" id="growl1">
            ...
            <div class="col-12 col-lg-8" style="display: none" id="editmode">
                <div class="alert alert-warning alert-dismissible fade show mb-4" role="alert">
                    <div class="alert-heading">Notice</div>
                    <p class="small mb-3">Changes to this LDAP configuration will affect the following tenants:</p>
                    <dl class="row ts-14">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input value="ldap://ads.mydomain.edu" aria-labelledby="" class="form-control" id="ldap_url" type="text" >
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input value="ou=myOu,dc=ads,dc=myDomain,dc=edu" aria-labelledby="" class="form-control" id="ldap_base" type="text" >
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input value="cn=myUser,ou=myOu,dc=ads,dc=myDomain,dc=edu" aria-labelledby="" class="form-control" id="ldap_username" type="text" >
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <input value="xxxxxxxxx" aria-labelledby="" class="form-control" id="ldap_password" type="password">
                        </div>
                    </div>
                </div>
...
<script>
$(document).ready(function() {
    $("#button_editmode").click(function() {
        $("#editmode").show();
        $("#viewmode").hide();
        $("#submitform").prop('disabled', true);
    });
