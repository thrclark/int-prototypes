<!-- Modal -->
<div class="modal fade" id="modal_gensettings_appname" tabindex="-1" role="dialog" aria-labelledby="modal_gensettings_appname_Label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title" id="modal_gensettings_appname_Label">General settings</div>
