        ...
        <div class="rbt-shell-sidebar d-none d-md-block" style="box-shadow: 0 1px 3px 2px rgba(0, 0, 0, 0.07); flex-basis: 30rem;width: 30rem; position:relative; overflow: inherit;transition: all 0.3s ease; ">
            ...
            <div class="position-relative h-100 overflow-hidden demo-theme-builder">
                <nav class="newsidebar-nav" style="padding: 4px">
                    <button type="button" class="btn btn-link btn-block border d-flex align-items-center mb-3 text-body" id="show_theme_colors">
                    ...
                    <button type="button" class="btn btn-link btn-block border d-flex align-items-center mb-3 text-body" id="show_theme_name">
                    <div class="font-weight-normal flex-grow-1 text-left">Name</div>
                    <i class="rbt-icon-exclamation mb-0 ml-auto text-danger demojs_validation"></i>
                    <div class="ml-3 mt-1"><i class="rbt-icon-chevron-right mb-0"></i></div>
                    </button>
                    <button type="button" class="btn btn-link btn-block border d-flex align-items-center mb-3 text-body" id="show_theme_applogo">
                    <div class="font-weight-normal flex-grow-1 text-left">Application logo</div>
                  <i class="rbt-icon-exclamation mb-0 ml-auto text-danger demojs_validation"></i>
                    <div class="ml-3 mt-1"><i class="rbt-icon-chevron-right mb-0"></i></div>
                    </button>
                    <button type="button" class="btn btn-link btn-block border d-flex align-items-center mb-3 text-body" id="show_theme_appicons">
                    <div class="font-weight-normal flex-grow-1 text-left">Application icons</div>
                    <i class="rbt-icon-exclamation mb-0 ml-auto text-danger demojs_validation"></i>
                    <div class="ml-3 mt-1"><i class="rbt-icon-chevron-right mb-0"></i></div>
                    </button>
                    <button type="button" class="btn btn-link btn-block border d-flex align-items-center mb-3 text-body" id="show_theme_customheadfoot">
                    <div class="font-weight-normal flex-grow-1 text-left">Custom header &amp; footer</div>
                    <i class="rbt-icon-exclamation mb-0 ml-auto text-danger demojs_validation"></i>
                    <div class="ml-3 mt-1"><i class="rbt-icon-chevron-right mb-0"></i></div>
                    </button>
                    <button type="button" class="btn btn-link btn-block border d-flex align-items-center mb-3 text-body" id="show_theme_fontfamily">
                    <div class="font-weight-normal flex-grow-1 text-left">Font family</div>
                    <i class="rbt-icon-exclamation mb-0 ml-auto text-danger demojs_validation"></i>
                    <div class="ml-3 mt-1"><i class="rbt-icon-chevron-right mb-0"></i></div>
                    </button>
                    <button type="button" class="btn btn-link btn-block border d-flex align-items-center mb-3 text-body" id="show_theme_fontsize">
                    <div class="font-weight-normal flex-grow-1 text-left">Font size</div>
                     <i class="rbt-icon-exclamation mb-0 ml-auto text-danger demojs_validation"></i>
                    <div class="ml-3 mt-1"><i class="rbt-icon-chevron-right mb-0"></i></div>
                    </button>
                    <button type="button" class="btn btn-link btn-block border d-flex align-items-center mb-3 text-body" id="show_theme_marginradius">
                ...
                <div class="newsidebar-section  hidden" id="theme_colors">
                    <div class="newsidebar-section-content card">
                        <div class="card-header d-flex align-items-center" style="padding-left: 5px">
                            ...
                            <h3 class="newsidebar-section-header">Colors</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="newsidebar-section  hidden" id="theme_name">
                    <div class="newsidebar-section-content card">
                        <div class="card-header d-flex align-items-center" style="padding-left: 5px">
                            <button class="btn btn-link text-body p-2 mr-1 demojs_backtothemenav"><i class="rbt-icon-chevron-left ts-20" style="margin-top: 8px;"></i><span class="sr-only">Back to categories</span></button>
                            <h3 class="newsidebar-section-header">Name</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="newsidebar-section  hidden" id="theme_applogo">
                    <div class="newsidebar-section-content card">
                        <div class="card-header d-flex align-items-center" style="padding-left: 5px">
                            <button class="btn btn-link text-body p-2 mr-1 demojs_backtothemenav"><i class="rbt-icon-chevron-left ts-20" style="margin-top: 8px;"></i><span class="sr-only">Back to categories</span></button>
                            <h3 class="newsidebar-section-header">Application logo</h3>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                ...
                <div class="newsidebar-section  hidden" id="theme_appicons">
                    <div class="newsidebar-section-content card">
                        <div class="card-header d-flex align-items-center" style="padding-left: 5px">
                            <button class="btn btn-link text-body p-2 mr-1 demojs_backtothemenav"><i class="rbt-icon-chevron-left ts-20" style="margin-top: 8px;"></i><span class="sr-only">Back to categories</span></button>
                            <h3 class="newsidebar-section-header">Application icons</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="newsidebar-section  hidden" id="theme_customheadfoot">
                    <div class="newsidebar-section-content card">
                        <div class="card-header d-flex align-items-center" style="padding-left: 5px">
                            <button class="btn btn-link text-body p-2 mr-1 demojs_backtothemenav"><i class="rbt-icon-chevron-left ts-20" style="margin-top: 8px;"></i><span class="sr-only">Back to categories</span></button>
                            <h3 class="newsidebar-section-header">Custom header &amp; footer</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="newsidebar-section  hidden" id="theme_fontfamily">
                    <div class="newsidebar-section-content card">
                        <div class="card-header d-flex align-items-center" style="padding-left: 5px">
                            <button class="btn btn-link text-body p-2 mr-1 demojs_backtothemenav"><i class="rbt-icon-chevron-left ts-20" style="margin-top: 8px;"></i><span class="sr-only">Back to categories</span></button>
                            <h3 class="newsidebar-section-header">Font family</h3>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                ...
                <div class="newsidebar-section  hidden" id="theme_fontsize">
                    <div class="newsidebar-section-content card">
                        <div class="card-header d-flex align-items-center" style="padding-left: 5px">
                            <button class="btn btn-link text-body p-2 mr-1 demojs_backtothemenav"><i class="rbt-icon-chevron-left ts-20" style="margin-top: 8px;"></i><span class="sr-only">Back to categories</span></button>
                            <h3 class="newsidebar-section-header">Font size</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="newsidebar-section  hidden" id="theme_marginradius">
                    <div class="newsidebar-section-content card">
                        <div class="card-header d-flex align-items-center" style="padding-left: 5px">
                            <button class="btn btn-link text-body p-2 mr-1 demojs_backtothemenav"><i class="rbt-icon-chevron-left ts-20" style="margin-top: 8px;"></i><span class="sr-only">Back to categories</span></button>
                            <h3 class="newsidebar-section-header">Margin &amp; radius</h3>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
...
<script>
    $(document).ready(function() {
        $("#show_theme_colors").click(function() {
            $("#theme_colors").removeClass("hidden");
            $(".newsidebar-nav").addClass("hidden");
        });
            $("#show_theme_name").click(function() {
            $("#theme_name").removeClass("hidden");
            $(".newsidebar-nav").addClass("hidden");
        });
          $("#show_theme_applogo").click(function() {
            $("#theme_applogo").removeClass("hidden");
            $(".newsidebar-nav").addClass("hidden");
        });
          $("#show_theme_appicons").click(function() {
            $("#theme_appicons").removeClass("hidden");
            $(".newsidebar-nav").addClass("hidden");
        });
        
          $("#show_theme_customheadfoot").click(function() {
            $("#theme_customheadfoot").removeClass("hidden");
            $(".newsidebar-nav").addClass("hidden");
        });
        
         $("#show_theme_fontfamily").click(function() {
            $("#theme_fontfamily").removeClass("hidden");
            $(".newsidebar-nav").addClass("hidden");
        });
         $("#show_theme_fontsize").click(function() {
            $("#theme_fontsize").removeClass("hidden");
            $(".newsidebar-nav").addClass("hidden");
        });
          $("#show_theme_marginradius").click(function() {
            $("#theme_marginradius").removeClass("hidden");
            $(".newsidebar-nav").addClass("hidden");
        });
         $(".demojs_backtothemenav").click(function() {
            $("#theme_colors, #theme_name, #theme_applogo,#theme_appicons,#theme_customheadfoot,#theme_fontfamily,#theme_fontsize,#theme_marginradius").addClass("hidden");
            $(".newsidebar-nav").removeClass("hidden");
        });
    });
</script> 
