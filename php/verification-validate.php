            ...
            <div class="card-body">
                ...
                <ul class="list-group">
                    <li class="list-group-item">
                        <div class="alert alert-inline alert-danger mb-3" role="alert" ><span class="rbt-icon-close-circle" aria-hidden="true"></span>
                            <p class="rbt-ts-14" id="standalone4	"> Some items in this section have not been fully verified. Select 'edit' to complete verification, and then refresh this section.</p>
                        </div>
                        <dl class="row">
