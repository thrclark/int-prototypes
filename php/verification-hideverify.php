...
<main class="main-content container int-theme-margin  p-0">
    ...
    <div class="int-verify-controls py-3 px-3 px-lg-0">
        ...
        <div class="row mb-5" id="demojs_verifyscreen">
            <div class="col-md-6 d-flex pb-5 pb-md-0 offset-md-3">
                <div class="d-flex flex-fill flex-column">
                     <div class="mb-3 ts-20"> Deferral text goes here air day called, abundantly forth she'd night may winged sea their whales you'll them seas set.</div>
