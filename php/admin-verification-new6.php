            ...
            <div class="col-12 col-sm-10 p-sm-5 pt-4 border-left int-panel">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        ...
                        <hr class="mt-7">
                        <div class="rbt-button-group mt-3 mb-5" id="saveRecipients"> <a href="admin-verification-new5.php" class="btn btn-outline-primary"> <i class="rbt-icon-chevron-left"></i> Previous </a> <a href="verification-preview.php" target="_blank" class="btn btn-outline-primary d-md-none"> Preview <i class="rbt-icon-link-external"></i> </a>
